...
Ambiente de desenvolvimento de IA otimizado para Gemini API, focado em desenvolvimento profissional C#/.NET com baixo consumo de recursos.

## 🎯 Foco Principal
- **Gemini API**: Setup otimizado para máxima performance com Google API
- **OpenHands V1**: Última interface web com padrões oficiais de configuração V1
- **VS Code + Copilot**: Integração perfeita para desenvolvimento do dia a dia
- **Suporte a GPU**: Suporte completo a NVIDIA GPU com otimizações
- **Docker Sandbox**: Provedor de sandbox Docker oficial com montagem de workspace

## 📋 Descrição do Projeto

Este projeto transforma seu ambiente em uma poderosa estação de desenvolvimento IA com Gemini API, com foco específico em C# e .NET. Usa o Gemini 3.1 Flash Lite Preview do Google, um modelo rápido e eficiente que funciona em qualquer hardware.

### 🎯 Visão de Negócios
- Produtividade máxima com Gemini API (custo mínimo)
- Setup universal com suporte opcional a GPU
- Foco em desenvolvimento C#/.NET Enterprise
- Configuração simplificada com validação automática
- Multi-arquitetura: apenas CPU ou acelerado por GPU

### 🔧 Visão Técnica
- **API Otimizada**: Gemini 3.1 Flash Lite Preview para máxima performance
- **Aceleração GPU**: Suporte NVIDIA com runtime otimizado
- **Universal**: Funciona em qualquer hardware (CPU ou GPU)
- **Integração VS Code**: Copilot para workflow nativo
- **Docker Simplificado**: OpenHands otimizado com config.toml
- **Integração MCP**: Model Context Protocol para extensibilidade
...
│   ├── AGENTS.md        # Guia mestre de agents
│   ├── skills/          # Skills especializadas .NET
│   │   ├── dotnet-best-practices/     # SOLID, C# moderno, patterns
...
│   │   ├── design-patterns/           # SOLID, GoF, padrões arquiteturais
│   │   ├── security-jwt/              # Autenticação, autorização
│   │   └── performance-optimization/  # Profiling, caching, otimização
...
│       ├── api-design-guidelines.md      # Design de REST API e HTTP
│       ├── database-conventions.md       # Design de banco de dados e EF Core
│       └── git-workflow.md               # Workflow Git e controle de versão
├── openhands/           # Configuração OpenHands AI
│   ├── settings.json    # Configuração Gemini API (JSON)
│   ├── config.json      # Configuração LLM (JSON)
│   ├── config.toml      # Configuração OpenHands V1 (TOML)
│   └── README.md        # Documentação completa
├── workspace/           # Workspace compartilhado
│   └── README.md        # Estrutura e organização
├── vscode/              # Configuração VS Code
│   ├── settings.json    # Settings otimizados
│   ├── extensions.json  # Extensões recomendadas
│   └── README.md        # Setup completo VS Code
├── docker-compose.yml   # Configuração Docker Otimizada (GPU)
├── docker-compose.low-resource.yml # Configuração apenas CPU
├── MCP-README.md        # Guia completo MCP
├── MCP-QUICKSTART.md    # Setup rápido MCP
├── configure.sh         # Script de configuração avançado
...
- **MCP**: Integração com servidores especializados
...
- **API otimizada**: Integração Gemini 3.1 Flash Lite Preview
...
- **[GitHub Copilot Agents](./agents/AGENTS.md)**: Skills e rules para automação .NET
...
## 🤖 Configuração GitHub Copilot Agents
...
- **Especialização**: Desenvolvimento C#/.NET
...
- **API**: Integração Gemini 3.1 Flash Lite Preview
...
- **MCP**: Integração com 9 servidores especializados
